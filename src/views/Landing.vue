            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Lorem Ipsum is simply dummy text
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-md-6 order-md-2">
                        <img src="img/app/lurus3.jpg" class="img-fluid floating">
                    </div>
                            ...
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h6 class="mb-0">Lorem Ipsum is simply dummy text</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                ...
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            <img v-lazy="'img/app/fishing1.jpg'" class="card-img-top">
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">Lorem Ipsum is simply dummy text</h4>
                                <p class="lead text-italic text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="section section-lg">
            <div class="container">
                <div class="row justify-content-center text-center mb-lg">
                    <div class="col-lg-8">
                        <h2 class="display-3">Lorem Ipsum is simply dummy text</h2>
        ...
        <section class="section section-shaped my-0 overflow-hidden">
            ...
            <div class="container pt-lg pb-300">
                <div class="row text-center justify-content-center">
                    <div class="col-lg-10">
                        <h2 class="display-3 text-white">Lorem Ipsum is simply dummy text</h2>
                        <p class="lead text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <h4 class="mb-1">Want contact us?</h4>
                            <p class="mt-0">paste messsage here!.</p>
